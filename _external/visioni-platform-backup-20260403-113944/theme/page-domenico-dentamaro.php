...
<section class="bg-paper py-20 md:py-24 border-t border-ink/10">
    <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8">
        <article class="lg:col-span-7 bg-white border border-ink/10 rounded-3xl p-8 md:p-10 shadow-sm">
            ...
            <p class="mt-4 text-ink/75 leading-8">
                In questa pagina convergono autorevolezza personale, visibilita del brand e interscambio editoriale con i canali del gruppo: un presidio utile per SEO, reputazione e fiducia commerciale lungo tutto il funnel.
            </p>
        </article>
...
<section class="bg-white py-20 md:py-24 border-t border-ink/10">
    <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div class="lg:col-span-5">
            ...
            <p class="mt-6 text-ink/75 leading-8">
                La stessa immagine della copertina viene riportata anche nel corpo pagina per rafforzare riconoscibilita personale, coerenza visiva e segnali semantici su nome, volto e brand.
            </p>
            <p class="mt-4 text-ink/75 leading-8">
                Questo blocco migliora la continuita tra hero, contenuto editoriale e condivisione social, con un riferimento visivo chiaro su Domenico Dentamaro.
            </p>
        </div>
        <figure class="lg:col-span-7 rounded-3xl overflow-hidden border border-ink/10 shadow-lg bg-paper">
            <img src="<?php echo esc_url( $hero_image ); ?>" alt="Domenico Dentamaro - Imprenditore immobiliare a Bari" class="w-full h-full object-cover" loading="lazy" decoding="async" />
