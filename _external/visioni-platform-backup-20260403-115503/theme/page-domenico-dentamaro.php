...
$faq_items = array(
    ...
    array(
        'q' => 'Qual e il valore distintivo del portale Visioni Immobiliari?',
        'a' => 'Visioni Immobiliari unisce selezione immobiliare, lettura strategica del territorio e approccio operativo orientato alla valorizzazione nel medio-lungo periodo.',
    ),
    array(
        'q' => 'A chi si rivolge Visioni Immobiliari?',
        'a' => 'Il portale si rivolge a privati, investitori e operatori che cercano immobili, cantieri, terreni e operazioni con analisi professionale e visione evolutiva del valore.',
    ),
    array(
        'q' => 'Quali contenuti offre il portale oltre agli annunci?',
        'a' => 'Visioni Immobiliari integra schede, approfondimenti e collegamenti al network 2D per offrire un contesto decisionale piu completo, non limitato alla sola vetrina.',
    ),
);
?>
...
<section class="relative min-h-[58vh] bg-ink text-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 md:px-12 pt-44 pb-16">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8">
        <article class="lg:col-span-7 bg-white border border-ink/10 rounded-3xl p-8 md:p-10 shadow-sm">
            ...
            <p class="mt-4 text-ink/75 leading-8">
                L'obiettivo è dare al cliente una lettura piu chiara del valore reale e futuro dell'asset, con un linguaggio professionale e una regia coerente su tutto l'ecosistema 2D.
            </p>
            <p class="mt-4 text-ink/75 leading-8">
...
<section class="bg-white py-16 md:py-20 border-t border-ink/10">
    <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div class="lg:col-span-5">
            <blockquote class="rounded-2xl border border-ink/10 bg-paper p-6 md:p-7">
        ...
        <figure class="lg:col-span-7 rounded-3xl overflow-hidden border border-ink/10 shadow-lg bg-[#f3efe7]">
            <img src="<?php echo esc_url( $hero_image ); ?>" alt="Domenico Dentamaro - Imprenditore immobiliare a Bari" class="w-full h-auto max-h-[500px] object-contain" loading="lazy" decoding="async" />
        </figure>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="https://www.2dsviluppoimmobiliare.it" target="_blank" rel="noopener noreferrer" class="rounded-2xl bg-paper border border-ink/10 p-6 hover:border-gold transition-colors">
                ...
                <h3 class="mt-1 text-2xl text-ink font-semibold tracking-tight"><span class="inline-flex items-baseline gap-[1px]"><span class="leading-none">2</span><span class="leading-none">D</span></span> Sviluppo Immobiliare</h3>
            </a>
