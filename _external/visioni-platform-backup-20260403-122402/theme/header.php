...
<header id="site-header" class="fixed top-0 left-0 right-0 z-[1000] transition-all duration-500 py-8 md:py-16 header-preload">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateHeader();
    requestAnimationFrame(() => header.classList.remove('header-preload'));
