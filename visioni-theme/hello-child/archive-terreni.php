<?php
/**
 * The template for displaying the terreni archive
 */

get_header(); ?>

<div class="archive-terreni-container min-h-screen bg-paper pt-24 pb-24">
    <div class="relative h-[40vh] min-h-[400px] mb-16 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=2064&q=80" alt="Terreni e Lotti" class="w-full h-full object-cover" />
        <div class="absolute inset-0 bg-ink/50 flex flex-col items-center justify-center text-center px-6">
            ...
            <h1 class="text-5xl md:text-7xl font-serif text-white leading-tight mb-6">
                Terreni <span class="italic font-light text-white/80">Edificabili</span>
            </h1>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <?php endwhile; else : ?>
                <p><?php esc_html_e( 'Nessun terreno trovato.', 'textdomain' ); ?></p>
            <?php endif; ?>
        </div>
