<?php
/**
 * The template for displaying the operazioni archive
 */

get_header(); ?>

<div class="archive-operazioni-container min-h-screen bg-ink text-white pt-24 pb-24">
    <div class="relative h-[40vh] min-h-[400px] mb-16 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Operazioni Immobiliari" class="w-full h-full object-cover" />
        <div class="absolute inset-0 bg-ink/70 flex flex-col items-center justify-center text-center px-6">
            ...
            <h1 class="text-5xl md:text-7xl font-serif text-white leading-tight mb-6">
                Operazioni <span class="italic font-light text-gold">Immobiliari</span>
            </h1>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <?php endwhile; else : ?>
                <p><?php esc_html_e( 'Nessuna operazione trovata.', 'textdomain' ); ?></p>
            <?php endif; ?>
        </div>
