...
<section class="relative min-h-[58vh] bg-ink text-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 md:px-12 pt-56 md:pt-64 pb-16">
...
<section class="bg-white py-16 md:py-20 border-t border-ink/10">
    <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <figure class="lg:col-span-7 rounded-3xl overflow-hidden border border-ink/10 shadow-lg bg-transparent">
            <img src="<?php echo esc_url( $hero_image ); ?>" alt="Domenico Dentamaro - Imprenditore immobiliare a Bari" class="block mx-auto w-auto max-w-full h-auto max-h-[500px]" loading="lazy" decoding="async" />
        </figure>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="https://www.2dsviluppoimmobiliare.it" target="_blank" rel="noopener noreferrer" class="rounded-2xl bg-paper border border-ink/10 p-6 hover:border-gold transition-colors">
                ...
                <h3 class="mt-1 text-2xl text-ink font-semibold tracking-tight"><span class="font-sans font-semibold tracking-[0.01em]">2D</span> Sviluppo Immobiliare</h3>
            </a>
